...
Atuação full-cycle em 5 produtos simultâneos. Responsável por back-end, integrações e suporte ao mobile em ambiente multiempresa.
...
- Liderança técnica e desenvolvimento de software na refatoração completa da API do projeto Dipemax.  
