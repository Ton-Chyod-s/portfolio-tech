<div class="profile-card">
  ...
  <div>
    ...
    <p style="margin: 0; font-size: 16px; color: #666;">Desenvolvedor de Software Pleno</p>
...
- Experiência com **Node.js, TypeScript, AdonisJS, PostgreSQL, Sequelize** e ecossistema de desenvolvimento de software moderno.
...
- **Mega Júnior (UFMS) - Jun/2025 a Jan/2026:** Atuei como Tech Lead e desenvolvedor de software na refatoração completa da API do projeto Dipemax, aplicando Clean Architecture, Node.js, TypeScript, JWT e Swagger.
